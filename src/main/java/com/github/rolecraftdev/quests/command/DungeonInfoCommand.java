...
/**
 * Command to view information about a dungeon.
 *
 * @since 0.1.0
 */
public final class DungeonInfoCommand extends CommandHandler {
    private final RolecraftQuests quests;

    /**
     * @since 0.1.0
     */
    public DungeonInfoCommand(@Nonnull final RolecraftQuests plugin) {
