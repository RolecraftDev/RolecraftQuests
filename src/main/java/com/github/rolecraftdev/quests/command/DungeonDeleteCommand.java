...
/**
 * Command to delete a dungeon.
 *
 * @since 0.1.0
 */
public final class DungeonDeleteCommand extends CommandHandler {
    private final RolecraftQuests quests;

    /**
     * @since 0.1.0
     */
    public DungeonDeleteCommand(@Nonnull final RolecraftQuests plugin) {
