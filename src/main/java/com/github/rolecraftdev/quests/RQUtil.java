...
/**
 * Contains constants and utility methods frequently used in RolecraftQuests.
 *
 * @since 0.1.0
 */
public abstract class RQUtil {
    /**
     * A 'quoted' underscore, usable in regex without inferring the special
     * meaning of the '_' character.
     *
     * @since 0.1.0
     */
